...
// [NEW] Include My shader class header
// Since the include folder is added to the path in CMakeLists.txt, it can be found directly.
#include "Shader.h"
